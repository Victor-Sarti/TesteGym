        ...
        <>
            <div className="flex items-center justify-center min-h-screen text-customWhite p-6">
                <div className="flex flex-col lg:flex-row items-center gap-8">
                    <div className="flex items-center justify-center lg:min-h-screen w-full">
                        <div className="relative">
                            ...
                            <img src={ManTwo} className="absolute bottom-[-70px] left-[-20px] sm:left-[-50px] w-80 h-48 bg-cover bg-center rounded-lg shadow-lg border-4 border-customDarkGray transform" alt="" />
                        </div>
                    </div>
                    {/* Texto e botão */}
                    <div className="text-left max-w-md w-full">
                        <h2 className="text-2xl sm:text-3xl font-bold mb-4">THE CLASS YOU WILL</h2>
                        <h2 className="text-2xl sm:text-3xl font-bold mb-4">GET HERE</h2>
                        <p className="text-customLightGray mb-6 text-sm sm:text-base">
